...
<div class="thumbnail">
  <div class="row">
    <div class="col-md-5">
      <img src="<?php if(!empty($user['image'])) : echo '/img/upload/'.$user['image']; else: ?>http://chicagoluvbiz.com/wp-content/uploads/2014/01/wine-icon.png<?php endif ?>" alt="..." class="img-responsive img-rounded">
    </div> 
