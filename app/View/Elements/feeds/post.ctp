<div style="padding-bottom: 20px;">	
	<div class="media">
  		<a class="pull-left" href="<?= $this->Html->url(array('controller' => 'users', 'action' => 'feeds', 'pseudo' => $post['Author']['slug'])) ?>">
    		<img class="media-object img-rounded" src="<?php if(!empty($post['Author']['image'])) : echo '/img/upload/'.$post['Author']['image']; else: ?>http://chicagoluvbiz.com/wp-content/uploads/2014/01/wine-icon.png<?php endif ?>" alt="..." style="width: 50px;">
  		</a>
