...
<div class="row">
	...
	<div class="col-md-4">
		...
		<?php foreach($events as $event) : ?>
			...
			<br />
			<small class="pull-right" style="margin-top: 5px;"> 598 Invités</a></small><small> par <a href="<?= $this->Html->url(array('controller' => 'users', 'action' => 'feeds', 'pseudo' => 1)) ?>">qdeneuve</a></small></h4>
